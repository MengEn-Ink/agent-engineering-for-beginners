...
export function reviewDateInShanghai(now = new Date()): string {
...
export function isReviewOverdue(reviewBy: string, now = new Date()): boolean {
  return reviewBy < reviewDateInShanghai(now)
}
